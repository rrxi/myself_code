 ...
 *
 *    Description:  define KbBibtex class
 *
 *        Version:  1.0
 *        Created:  2019年05月15日 15时32分02秒
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (),
...
static void kb_bibtex_set_property(GObject *object, guint property_id,
...
static void kb_bibtex_get_property(GObject *object, guint property_id,
